...
if __name__ == "__main__":
    ...
    rotate_model.load_checkpoint('src/kg4rd/extractor/experimental_dmd/kge/checkpoints/rotate/all/rotate-100.pth')
    ...
    print(len(all_drug_ent_id))

    df = link.link(dmd_ent_id, drug_dis_rel_id, all_drug_ent_id, topk=50, device='cuda:3')
    print(df)