...
do_df = pd.read_csv('data/data_synonyms/do_synonyms_mondo_id.csv').drop(['id'], axis=1).rename(columns={'mondo_id': 'id'})
orphanet_df = pd.read_csv('data/data_synonyms/orphanet_synonyms.csv').drop(['id'], axis=1).rename(columns={'mondo_id': 'id'})
mondo_df = pd.read_csv('data/data_synonyms/mondo_synonyms.csv')
